<footer id="footer" class="footer-default xl-pb-70 bg-surface-5">
    <div class="footer-top">
        <div class="container">
            <div class="footer-top-wrap">
                <div class="footer-logo">
                    <a href="index.html">
                        <img src="{{ asset('frontend_assets/images/logo/logo.svg')}}" class="logo" alt="logo">
                    </a>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-wrap">
                <p class="text-dark">Copyright © 2025 by <span class="fw-medium">Smiles.</span> All Rights
                    Reserved.</p>
                <ul class="tf-payment">
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/EximBank.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/ApplePay.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/DinersClub.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/Discover.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/GooglePay.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/Mastercard-2.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/Mastercard.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/Shop.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/UnionPay.png')}}" alt="payment"></li>
                    <li class="item"><img src="{{ asset('frontend_assets/images/payment/Visa.png')}}" alt="payment"></li>
                </ul>
            </div>
        </div>
    </div>
