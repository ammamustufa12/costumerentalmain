        ...
        <div class="tf-breadcrumb mb-27">
            <div class="container">
                <ul class="breadcrumb-list">
                    ...
                    <li class="item-breadcrumb">
                        <span class="text">Dance Class Details </span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container-full">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                        <div class="tf-product-grid tf-col-4" id="costumeContainer">
                            @forelse($costumes as $costume)
                                <div class="card-product-wrapper">
                                    <a href="{{ route('product.detail', $costume->id) }}" class="product-img">
                                        <img class="img-product lazyload"
                                             data-src="{{ asset('storage/' . $costume->image) }}"
                                        ...
                                        <img class="img-hover lazyload"
                                             data-src="{{ asset('storage/' . $costume->image) }}"
                                             src="{{ asset('storage/' . $costume->image) }}"
                                             alt="{{ $costume->name }} (Hover)">
                                    </a>
                    
                                    @if($costume->discount > 0)
                                        <div class="on-sale-wrap">
                                            <span class="on-sale-item">{{ $costume->discount }}% Off</span>
                                        </div>
                                    @endif
                    
                                    <div class="card-product-info">
                                        <a href="{{ route('product.detail', $costume->id) }}" class="name-product link fw-medium text-md">
                                            {{ $costume->name }}
                                        </a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-primary">AED {{ number_format($costume->price, 2) }}</span>
                                            @if($costume->discount > 0)
                                                <span class="price-old">
                                                    AED {{ number_format($costume->price / (1 - ($costume->discount / 100)), 2) }}
                                                </span>
                                            @endif
                                        </p>
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                <span class="tooltip color-filter">{{ $costume->category->name ?? 'Costume' }}</span>
                                                <span class="swatch-value bg-grey-4"></span>
                                                <img class="lazyload"
                                                     data-src="{{ asset('storage/' . $costume->image) }}"
                                                     src="{{ asset('storage/' . $costume->image) }}"
                            ...
                            @empty
                                <p class="text-center text-muted">No costumes available in this category.</p>
                            @endforelse
                        </div>
