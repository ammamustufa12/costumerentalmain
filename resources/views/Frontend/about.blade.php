...
<!-- Mirrored from vineta-html.vercel.app/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Apr 2025 06:50:19 GMT -->
        ...
        <section class="flat-spacing-3 pb-0">
            <div class="container">
                <div class="flat-title-2 d-xl-flex justify-content-xl-between">
                    ...
                    <div class="box-text">
                        <p class="text-md">
                            At <span class="fw-medium">Vineta</span>, we bring you thoughtfully curated collections that
                            blend contemporary <br class="d-none d-xl-block">
                            designs with timeless elegance. With over 15 years of experience, we cater to <br
                ...
                <div class="image radius-16 overflow-hidden banner-about">
                    <img src="{{ asset('frontend_assets/images/section/about.jpg')}}" data-src="{{ asset('frontend_assets/images/section/about.jpg')}}" alt=""
            ...
            <div class="container">
                <div class="flat-title-2 text-center">
                    ...
                    <p class="text-md text-main">
                        ...
                        boundaries of <br class="d-none d-lg-block">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-md-6">
                        <div class="image radius-16 overflow-hidden w-100 h-100">
                            <img src="{{ asset('frontend_assets/images/section/about-2.jpg')}}" data-src="{{ asset('frontend_assets/images/section/about-2.jpg')}}" alt=""
        ...
        <section class=" flat-spacing-3 pt-0">
            <div class="container">
                <div class="flat-title-2 d-xl-flex justify-content-xl-between">
                    ...
                    <div class="box-text">
                        <p class="text-md">
                            Our skilled stylists have thoughtfully assembled seasonal outfits that are both <br
                                class="d-none d-xl-block"> trendy and
                            timeless. With a variety of looks, they’re here to inspire your next <br
                                class="d-none d-xl-block"> fashion-forward
                            ensemble.
                        </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="box-testimonial-quote text-center">
                    ...
                    <p class="text-xl-2 lh-xl-32">
                        "I've ordered from many places, but I have to say, this shop offers the best shipping <br
                            class="d-none d-lg-block"> experience
                        ever. Thank you so much for the outstanding service!"
                    </p>
                    <div class="box-author">
                        <div class="avt"><img src="{{ asset('frontend_assets/images/testimonial/tes-about.jpg')}}" alt=""></div>
                        ...
                        <div class="demo-item">
                            <a href="index.html" class="demo-image">
                                <img class="lazyload" data-src="images/demo/fashion-1.jpg"
                                    src="{{ asset('frontend_assets/images/demo/fashion-1.jpg')}}" alt="home-fashion">
