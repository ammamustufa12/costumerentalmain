            ...
            <div class="container-full">
                <div class="row align-items-center">
                    <div class="col-lg-2 col-xl-3 d-none d-lg-block">
                        <ul class="topbar-left tf-social-icon">
                    ...
                    <div class="col-lg-7 col-xl-6 overflow-hidden">
            ...
            <div class="row wrapper-header align-items-center">
                ...
                <div class="col-xl-2 col-md-4 col-6">
                    <a href="index.html" class="logo-header">
                        <a href="home-skincare.html" class="logo-header" style="font-size: 24px; font-weight: bold; color: black; text-transform: uppercase;">
                            Smiles Creations
                        </a>
                    </a>
                </div>
                <div class="col-xl-8 d-none d-xl-block">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-menu">
                            ...
                            <li class="menu-item">
                                <a href="#" class="item-link">Dance Classes</a>
        ...
        <section class="page-title flat-spacing-4 pt-0">
            <div class="container-full">
                <div class="box-title text-center justify-items-center">
                    ...
                    <p class="text-main text-md">Discover our carefully curated women's collection, where timeless
                        elegance
                        meets modern style.</p>
                    <button id="readMoreBtn" class="tf-btn btn-out-line-dark2">Read More</button>
                </div>
            </div>
        </section>
        <!-- /Title Page -->
            ...
            <div class="container-full">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                        <div class="tf-product-grid tf-col-4" id="danceClassContainer">
                            @forelse($classes as $class)
                                @php
                                    $images = is_array($class->images) ? $class->images : json_decode($class->images, true);
                                    $mainImage = $images[0] ?? 'frontend_assets/images/default-class.jpg';
                                    $hoverImage = $images[1] ?? $mainImage;
                                @endphp
                    
                                <div class="card-product grid card-product-size" data-availability="Available" data-brand="{{ $class->instructor }}">
                                    <div class="card-product-wrapper">
                                        <a href="{{ route('danceclass.detail', $class->id) }}" class="product-img">
                                            ...
                                            <img class="img-hover lazyload"
                                                 data-src="{{ asset('storage/' . $hoverImage) }}"
                                                 src="{{ asset('storage/' . $hoverImage) }}"
                                                 alt="{{ $class->name }} (Hover)">
                                        </a>
                    
                                        @if($class->discount > 0)
                                            <div class="on-sale-wrap">
                                                <span class="on-sale-item">{{ $class->discount }}% Off</span>
                                            </div>
                                        @endif
                                        ...
                                        <ul class="size-box">
                                            <li class="size-item text-xs text-white">Beginner</li>
                                            <li class="size-item text-xs text-white">Intermediate</li>
                                            <li class="size-item text-xs text-white">Advanced</li>
                                        </ul>
                                    </div>
                    
                                    <div class="card-product-info">
                                        <a href="{{ route('danceclass.detail', $class->id) }}" class="name-product link fw-medium text-md">
                                            {{ $class->name }}
                                        </a>
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-primary">AED {{ number_format($class->price, 2) }}</span>
                                            @if($class->discount > 0)
                                                <span class="price-old">
                                                    AED {{ number_format($class->price / (1 - ($class->discount / 100)), 2) }}
                                                </span>
                                            @endif
                                        </p>
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                <span class="tooltip color-filter">{{ $class->category->name ?? 'Dance' }}</span>
                                                <span class="swatch-value bg-grey-4"></span>
                                                <img class="lazyload"
                                                     data-src="{{ asset('storage/' . ($class->image ?? $mainImage)) }}"
                                                     src="{{ asset('storage/' . ($class->image ?? $mainImage)) }}"
                                                     alt="Dance Image">
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            @empty
                                <p class="text-center text-muted">No dance classes available.</p>
                            @endforelse
                        </div>
                    ...
                    <ul class="collapse-body list-recent">
                        ...
                        <li>
                            <div class="recent-blog-item">
                                ...
                                <div class="content">
                                    <a href="product-detail.html" class="title text-md link fw-medium">Short Sleeve Sweat</a>
                                    <div class="price text-md fw-medium">
