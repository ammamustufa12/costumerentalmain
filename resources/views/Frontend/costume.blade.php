        ...
        <div class="tf-breadcrumb space-t">
            <div class="container-full">
                <ul class="breadcrumb-list">
                    ...
                    <li class="item-breadcrumb">
                        <span class="text">Costume Rental</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <section class="page-title flat-spacing-4 pt-0">
            <div class="container-full">
                <div class="box-title text-center justify-items-center">
                    <h4 class="title">Costume Rental</h4>
            ...
            <div class="container-full">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="wrapper-shop tf-grid-layout tf-col-4" id="gridLayout">
                        <div class="row tf-product-grid tf-col-4" id="danceClassContainer">
                            @forelse($costume as $class)
                                <div class="card-product grid card-product-size" data-availability="Available" data-brand="{{ $class->instructor }}">
                                    <div class="card-product-wrapper">
                                        <a href="{{ route('product.detail', $class->id) }}" class="product-img">
                                            <img class="img-product lazyload" 
                                                 data-src="{{ asset('storage/' . $class->image) }}"
                                                 src="{{ asset('storage/' . $class->image) }}" 
                                                 alt="{{ $class->name }}">
                        
                                            <img class="img-hover lazyload" 
                                                 data-src="{{ asset('storage/' . ($class->hover_image ?? $class->image)) }}"
                                                 src="{{ asset('storage/' . ($class->hover_image ?? $class->image)) }}"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <p class="price-wrap fw-medium">
                                            <span class="price-new text-primary">${{ $class->price }}</span>
                                            @if($class->discount > 0)
                                                <span class="price-old">
                                                    ${{ number_format($class->price / (1 - ($class->discount / 100)), 2) }}
                                                </span>
                                            @endif
                                        </p>
                        
                                        {{-- Optional: Colors or Tags --}}
                                        <ul class="list-color-product">
                                            <li class="list-color-item hover-tooltip tooltip-bot color-swatch active">
                                                <span class="tooltip color-filter">Jazz</span>
                                                <span class="swatch-value bg-grey-4"></span>
                                                <img class="lazyload"
                                                     data-src="{{ asset('storage/' . $class->image) }}"
                                                     src="{{ asset('storage/' . $class->image) }}"
                            ...
                            @empty
                                <p>No dance costume available.</p>
                            @endforelse
                        </div>
